...
### break与continue
==都只能跳出所在的那个循环，不能跳出嵌套的==
`exit=1`
`if(exit) break;`

跳出嵌套==接力break==
![500](assets/第3-4章_判断与循环/file-20251223140017683.png)
goto
![500](assets/第3-4章_判断与循环/file-20251223140159017.png)
break：跳出循环；一般用于找到条件就退出，不做多余动作

continue：这一段循环后面的我不要了