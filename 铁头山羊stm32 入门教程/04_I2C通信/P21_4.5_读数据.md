...
![500](assets/P21_4.5_读数据/file-20260108154910583.png)
2.向最后一个比特位写1；我要读数据
## 3. 如何发送 ACK 和 NACK
...
![500](assets/P21_4.5_读数据/file-20260108160306740.png)
## 4. 如何发送停止位
*   **发送 STOP**: `I2C_GenerateSTOP(I2C1, ENABLE);`
    *   产生的时机通常紧随 NACK 之后。
![500](assets/P21_4.5_读数据/file-20260108160432419.png)
## 5. 读取 1 个字节 (Size = 1)
...
![500](assets/P21_4.5_读数据/file-20260108160515299.png)
![500](assets/P21_4.5_读数据/file-20260108161138593.png)
```c
	//# 3.接收数据
	if(Size == 1)
	{
...
![500](assets/P21_4.5_读数据/file-20260108162805942.png)
```c
	else if(Size() == 2)
	{
		//清除ADDR（读取SR1与SR2）
...
## 7.读取多个字节（==ACK=1代表应答==，0（disable）是非应答）
![500](assets/P21_4.5_读数据/file-20260108163839884.png)
![500](assets/P21_4.5_读数据/file-20260108165354986.png)