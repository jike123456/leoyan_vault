...
## 5. 波特率的设置方法
*   **概念**：波特率（Baud Rate）决定了==数据传输的速率==，单位是 bps (bit per second)。
...
![500](assets/P11_3.2_UART模块的使用方法/file-20251230194319376.png)
![500](assets/P11_3.2_UART模块的使用方法/file-20251230194936579.png)
